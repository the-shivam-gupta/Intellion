          ...
          <div class="row">
            <div class="col-lg-2 col-md-2">
              <div class="social_links_wrapper" data-aos="fade-up">
                ...
                >
                  <div class="social_icon">
                    <img src="~/assets/images/email_newsroom.svg" alt />
                  </div>
                </a>
                <a
                  rel="noopener"
            ...
            <div class="col-lg-8 col-md-8">
              <div class="news_wrapper">
                ...
                <div class="social_links_wrapper_mob">
                  ...
                  >
                    <div class="social_icon">
                      <img src="~/assets/images/mob_facebook.svg" alt />
                    </div>
                  </a>
                  <a
                    rel="noopener"
                  ...
                  >
                    <div class="social_icon">
                      <img src="~/assets/images/mob_twitter.svg" alt />
                    </div>
                  </a>
                  <a
                    rel="noopener"
                  ...
                  >
                    <div class="social_icon">
                      <img src="~/assets/images/mob_linkedin.svg" alt />
                    </div>
                  </a>
                  <a
                    rel="noopener"
                  ...
                  >
                    <div class="social_icon">
                      <img src="~/assets/images/mob_share_link.svg" alt="Mob Share link" />
                    </div>
                  </a>
                  <a
                    rel="noopener"
                ...
                <h5 data-aos="fade-up">{{ newsroomList.short_description }}</h5>
              </div>
            </div>
          </div>
        </div>
