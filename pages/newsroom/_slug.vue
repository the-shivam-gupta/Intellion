<template>
  <div id="newsroom-inner-page">
    <template v-if="!$fetchState.pending">
      <section class="section section-newsroom-inner">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <div class="news_back" data-aos="fade-in">
          ...
          <div class="row">
            <div class="col-lg-2 col-md-2">
              <div class="social_links_wrapper" data-aos="fade-up">
                <a
                  rel="noopener"
                  title="Share on Facebook"
                  aria-label="Share on Facebook"
                  @click.prevent="redirectUrl(fbSocialUrl)"
                  target="_blank"
                >
                ...
                <a
                  ...
                  @click.prevent="redirectUrl(twitterSocialUrl)"
                  target="_blank"
                >
                  <div class="social_icon">
                ...
                <a
                  ...
                  @click.prevent="redirectUrl(linkedinShareUrl)"
                  target="_blank"
                >
                  <div class="social_icon">
                ...
                <a
                  ...
                  :href="`mailto:?${mailShareUrl}`"
                  target="_blank"
                >
                  <div class="social_icon">
                    <img src="~/assets/images/email_newsroom.svg" alt="Email" />
                  </div>
                </a>
                <a
                  rel="noopener"
                  ...
                  @click.prevent="sharePageLink"
                  target="_blank"
                >
                  <div class="social_icon">
                    <img src="~/assets/images/share_link.svg" alt="Share Link" />
                  </div>
                </a>
              </div>
            </div>
            <div class="col-lg-8 col-md-8">
              <div class="news_wrapper">
                ...
                <div class="social_links_wrapper_mob">
                  <a
                    rel="noopener"
                    title="Share on Facebook"
                    aria-label="Share on Facebook"
                  ...
                  >
                    <div class="social_icon">
                      <img src="~/assets/images/mob_facebook.svg" alt="Facebook" />
                    </div>
                  </a>
                  <a
                    rel="noopener"
                  ...
                  >
                    <div class="social_icon">
                      <img src="~/assets/images/mob_twitter.svg" alt="Twitter" />
                    </div>
                  </a>
                  <a
                    rel="noopener"
                  ...
                  >
                    <div class="social_icon">
                      <img src="~/assets/images/mob_linkedin.svg" alt="Linkedin" />
                    </div>
                  </a>
                  <a
                    rel="noopener"
                  ...
                  >
                    <div class="social_icon">
                      <img src="~/assets/images/mob_email.svg" alt="Mob Email" />
                    </div>
                  </a>
                  <a
                    rel="noopener"
                  ...
                  >
                    <div class="social_icon">
                      <img src="~/assets/images/mob_share_link.svg" alt="Share Link" />
                    </div>
                  </a>
                  <a
                    rel="noopener"
                    ...
                    @click.prevent="redirectUrl(whatsAppSocialUrl)"
                    target="_blank"
                  >
                    <div class="social_icon">
                ...
                <h6 data-aos="fade-up">{{ newsroomList.date }}</h6>
                <div data-aos="fade-in" class="section__btn" v-if="newsroomList.media_releases_type && newsroomList.media_releases_type.media_release_url">
                  <ta-cta
                    text="Explore"
                    type="downloadLink"
                    btnStyle="ta__btn--primary"
                    :url="newsroomList.media_releases_type.media_release_url"
                  />
                </div>
                <div class="section__content" v-html="newsroomList.short_description" />
                <div data-aos="fade-in" v-html="newsroomList.description" />
                <ta-slick-slider v-if="isNuxtReady" :galleryImages="newsroomList.news_gallery"></ta-slick-slider>
              </div>
            </div>
          </div>
        </div>
...
export default {
  async fetch() {
    ...
    await store.dispatch("newsroom/getNewsroomInner", params);
  },
  head() {
    return {
      htmlAttrs: {
      ...
      title: this.newsroomList
        ? "Tata Intellion - " + this.newsroomList.title
        : "Tata Intellion",
  ...
  data() {
    return {
      ...
      hero_section: {
        title: "Newsroom",
        description:
          "Get the latest news, events and feature stories on our businesses, community initiatives, heritage and people.",
      },
  ...
  computed: {
    newsroomList: function () {
      return this.$store.state.newsroom.newsroomInner;
    },
    fbSocialUrl: function () {
    ...
    mailShareUrl: function () {
      return process.client
        ? "subject= TATA Intellion - " +
            this.$route.fullPath +
            " " +
            "&body= Hi, checkout this link from TATA Intellion" +
            "  " +
            " - " +
            window.location.origin +
            this.$route.fullPath
    ...
    sharePageLink: function () {
      return this.copyMessage(window.location.origin + this.$route.fullPath);
    },
    whatsAppSocialUrl: function () {
